...
class UserCrudView extends StatelessWidget {
  ...
  final List<Usuario> users = [
    Usuario(id: 1, nombre: 'Julian', email: 'polimenijulian9@gmail.com', rol: 'Admin'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: TablaCrud<Usuario>(
        tituloAppBar: 'Usuarios registrados', // Titulo del appBar
        encabezados: const ["ID", "NOMBRE", "EMAIL", "TIPO DE ROL", "OPCIONES"], // Encabezados
